...
<body>
        ...
        <h3>Privacy Policy for helbha Industries Private Limited</h3>
        <br>
        <p>At helbha, accessible from www.helbha.com, one of our main priorities is the
            privacy of our visitors. This Privacy Policy document contains types of information
            that is collected and recorded by helbha and how we use it.</p>
        ...
        <p>helbha follows a standard procedure of using log files. These files log visitors when
        ...
        <br>
        <p>Like any other website, helbha uses cookies. These cookies are used to store
        ...
        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
            that are used in their respective advertisements and links that appear on helbha,
        ...
        <p>Note that helbha has no access to or control over these cookies that are used by
            third-party advertisers.</p>
        <h3>Third Party Privacy Policies</h3>

        <p>helbha Privacy Policy does not apply to other advertisers or websites. Thus, we are
        ...
        <p>helbha does not knowingly collect any Personal Identifiable Information from children
